...
DATA.DIR <- setwd("C:/Users/shaki/Correctinstallment-Arrayanalysis/E-MEXP-2599/")
SCRIPT.DIR <- setwd("C:/Users/shaki/Kernsmooth-Notification-scripts/")
WORK.DIR <- setwd("C:/Users/shaki/Correctinstallment-Arrayanalysis/Output-E-MEXP-2599")
...
species <- "Homo sapiens" #see comments below
